...
# =============================================================================
    ...
    class T_NeuralNet(nn.Module):
            ...
            def __init__(self, input_dim, hidden_dim):
                ...
                self.layer_out_kf = nn.Linear(self.input_dim[0], input_dim[0], bias=False)
            ...
            def forward(self, x, y):
                ...
                xy = self.layer_out(self.activationReLu(xy)) + x_kf
...
# =============================================================================
        ...
        optimizer_T = torch.optim.Adam(T.parameters(), lr=learning_rate*50) #*50
        optimizer_f = torch.optim.Adam(f.parameters(), lr=learning_rate/10) # /10
# =============================================================================
...
# =============================================================================
        ...
        for i in range(iterations):
            ...
            if i >= iterations/4 and i <= iterations*3/4 and (i - iterations/4) <= final_iter/2 :
                scheduler_f.step()
                scheduler_T.step()        
# =============================================================================
...
# =============================================================================
            ...
            if ITERS > final_iter and i%1 == 0 and i>=20:
                ITERS = int(ITERS/2)
...
# =============================================================================
            ...
            SAVE_all_X_OT[k,i+1,:,:] = np.copy(map_T.detach().numpy())
