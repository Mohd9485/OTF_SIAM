...
# Kantorovich potential f(x, y) — scalar output, 2-block residual network with ELU
...
# Transport map T(x, y) — 3-block residual network with ReLU, outputs same dim as x
...
for dim in D:
    ...
    for lamda in Lambda:
        ...
        for k in range(AVG_SIM):
            ...
            # Compute W2 between OTF output and ground truth posterior
            p_true = int(1e3)
