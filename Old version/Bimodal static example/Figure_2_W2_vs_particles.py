...
#     plt.subplot(2,5,i+1)
#     plt.hist(X_SIR[:,i],density=True,bins=100)
...
for N in NN:
    ...
    for lamda in Lambda:
        ...
        for k in range(AVG_SIM): 
            ...
            x_transported = MAP_T.forward(x,y_true_OT).detach().numpy()
            ...
            if N > p_true:
                b = np.ones(p_true) / p_true # Uniform weights for Y
            else:
...
for N in NN:
    ...
    for k in range(AVG_SIM): 
        ...
        # time_save['sir'].append(track_time)
        ...
        # time_save['enkf'].append(track_time)
