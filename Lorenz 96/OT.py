...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 00:08:23 2024
...
def OT(Y,X0,parameters,A,h,t,tau,Noise,rk45):
...
# # =============================================================================
# #                 xy = self.layer_out(self.activationReLu(xy))
# # =============================================================================
#                 return xy
# =============================================================================
    ...
    class T_NeuralNet(nn.Module):
            ...
            def forward(self, x, y):
                ...
                # x_kf = x + (K@ (y.mean(axis=0,keepdims=True) - y_hat).T).T 
                ###############################################################
